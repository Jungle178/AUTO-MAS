...
export function useScriptApi() {
                      ...
                      Info: {
                        Name:
                          hsrUserData.Info?.Name !== undefined
                            ...
                            : `用户${userIndex.uid}`,
                        Status:
                          hsrUserData.Info?.Status !== undefined
                            ? hsrUserData.Info.Status
                            : true,
                        Id:
                          hsrUserData.Info?.Id !== undefined ? hsrUserData.Info.Id : '',
                        Password:
                          hsrUserData.Info?.Password !== undefined
                            ? hsrUserData.Info.Password
                            : '',
                        Server:
                        ...
                        RemainedDay:
                          hsrUserData.Info?.RemainedDay !== undefined
                            ...
                            : -1,
                        Notes:
                          hsrUserData.Info?.Notes !== undefined
                            ? hsrUserData.Info.Notes
                            : '',
                        Tag:
                          hsrUserData.Info?.Tag !== undefined
                            ? hsrUserData.Info.Tag
                            : null,
                      },
                      Stage: {
                        Channel:
  ...
  const getHsrStageOptions = async <T = unknown>(
    scriptId: string,
    engine: 'M7A' | 'SRA'
  ): Promise<T | null> => {
    try {
